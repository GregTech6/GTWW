...
//						System.out.println("test");
						if (stack.getItemDamage() == 0) {
							if (ConfigHandler.PlaySound)
								UT.Sounds.send("gtweapons:pistol", 0.5F, 0.4F / (itemRand.nextFloat() * 0.4F + 0.8F), player);
						...
						if (stack.getItemDamage() == 1) {
							if (ConfigHandler.PlaySound)
								UT.Sounds.send("gtweapons:smg", 0.5F, 0.4F / (itemRand.nextFloat() * 0.4F + 0.8F), player);
							player.getEntityWorld().spawnEntityInWorld(new EntityItem(world, player.posX, player.posY, player.posZ, new ItemStack(ModItems.ejectedBullet, 1, 0)));
						}
						if (stack.getItemDamage() == 2) {
							if (ConfigHandler.PlaySound)
								UT.Sounds.send("gtweapons:sniper", 0.5F, 0.4F / (itemRand.nextFloat() * 0.4F + 0.8F), player);
						...
						if (stack.getItemDamage() == 3) {
							if (ConfigHandler.PlaySound)
								UT.Sounds.send("gtweapons:blunderbuss", 0.5F, 0.4F / (itemRand.nextFloat() * 0.4F + 0.8F), player);
							player.getEntityWorld().spawnEntityInWorld(new EntityItem(world, player.posX, player.posY, player.posZ, OP.scrapGt.mat(MT.Paper, 2)));
						}
						if (stack.getItemDamage() == 4) {
							if (ConfigHandler.PlaySound)
								UT.Sounds.send("gtweapons:ar", 0.5F, 0.4F / (itemRand.nextFloat() * 0.4F + 0.8F), player);
						...
						if (stack.getItemDamage() == 5) {
							if (ConfigHandler.PlaySound)
								UT.Sounds.send("gtweapons:burst", 0.5F, 0.4F / (itemRand.nextFloat() * 0.4F + 0.8F), player);
